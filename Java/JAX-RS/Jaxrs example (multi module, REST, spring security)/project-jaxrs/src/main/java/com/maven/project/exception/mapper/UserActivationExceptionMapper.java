...
import com.maven.project.exceptions.user.UserActivationAccountAlreadyActiveException;
import com.maven.project.exceptions.user.UserActivationAccountBannedException;
import com.maven.project.exceptions.user.UserActivationActivationCodeExpiredException;
import com.maven.project.exceptions.user.UserActivationException;
import com.maven.project.exceptions.user.UserActivationInvalidLinkException;
